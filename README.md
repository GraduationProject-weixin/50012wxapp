...
# 50012wxapp微信小程序的科创微应用平台设计与实现

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1BPtKekEv3?p=14)
...
随着互联网技术的快速发展，网络时代的到来，网络信息也将会改变当今社会。各行各业在日常企业经营管理等方面也在慢慢的向规范化和网络化趋势汇合。基于微信小程序的科创微应用平台的信息化程度体现在将互联网与信息技术应用于经营与管理，以现代化工具代替传统手工作业。无疑，使用网络信息化管理使信息管理更先进、更高效、更科学，信息交流更迅速。

对于之前基于微信小程序的科创微应用平台的管理，大部分都是使用传统的人工方式去管理，这样导致了管理效率低下、出错频率高。而且，时间一长的话，积累下来的数据信息不容易保存，对于查询、更新还有维护会带来不少问题。对于数据交接也存在很大的隐患。如果采用电子化的存储方式就会带来很大的改善，而且给用户的查询带来了很大便利，因此设计一个基于微信小程序的科创微应用平台刻不容缓，能够提高信息的管理水平。
## 1.3系统设计思想
...
|baomingrenyuan|varchar(200)|是|NULL|报名人员|
...
|changdizhuangtai|varchar(200)|否||场地状态|
|changdiquyu|varchar(200)|否||场地区域|
|rongnarenshu|varchar(200)|是|NULL|容纳人数|
|changdifeiyong|int(11)|否||场地费用|
|keyueshijian|varchar(200)|是|NULL|可约时间|
|lianxidianhua|varchar(200)|是|NULL|联系电话|
|changdixiangqing|longtext|是|NULL|场地详情|
...
|changditupian|varchar(200)|是|NULL|场地图片|
|huiyizhuti|varchar(200)|是|NULL|会议主体|
|canhuirenshu|int(11)|是|NULL|参会人数|
|lianxiren|varchar(200)|是|NULL|联系人|
|lianxifangshi|varchar(200)|是|NULL|联系方式|
|changdifeiyong|int(11)|是|NULL|场地费用|
|shiyongshijian|datetime|是|NULL|使用时间|
|shiyongshizhang|float|是|NULL|使用时长|
|zongji|varchar(200)|是|NULL|总计|
...
|qiyeguimo|varchar(200)|是|NULL|企业规模|
|fuzeren|varchar(200)|是|NULL|负责人|
|shouji|varchar(200)|是|NULL|手机|
|qiyetupian|varchar(200)|是|NULL|企业图片|
|youxiang|varchar(200)|是|NULL|邮箱|
|qiyejianjie|longtext|是|NULL|企业简介|
表4.12 收藏表
...
|canguanmude|varchar(200)|是|NULL|参观目的|
|canguanshijian|datetime|是|NULL|参观时间|
|gongsixianyouyuangongshu|varchar(200)|是|NULL|公司现有员工数|
|suoxugongweishu|varchar(200)|是|NULL|所需工位数|
|cheliangxinxi|varchar(200)|是|NULL|车辆信息|
|qitarenyuan|varchar(200)|是|NULL|其他人员|
